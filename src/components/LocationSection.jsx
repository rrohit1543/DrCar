      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 h-[420px] rounded-2xl overflow-hidden border border-slate-800 shadow-2xl relative">
            ...
            <div className="absolute top-4 left-4 bg-slate-950/90 border border-slate-700 px-4 py-2 rounded-xl text-xs text-slate-200 font-semibold backdrop-blur-md">
              📍 Near D Mart, Nipania, Indore
            </div>
          </div>
